...
from src.topologicalCS import topologicalCS
...
class ModelTrainer:
    ...
    def load_and_split_data(self):
        ...
        base_process = topologicalCS(input_path=self.parquet_path, sample=False)
    ...
    def run_ml_pipeline(self):
        ...
        dummy_run = topologicalCS(input_path=self.parquet_path, sample=False)
